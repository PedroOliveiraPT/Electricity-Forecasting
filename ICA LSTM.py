...
history_results.to_csv('results/ICA_LSTM_60secs_loss.csv')
model.save('models/ICA_LSTM_60secs.h5')
...
prediction_results.to_csv('results/ICA_LSTM_60secs_prediction.csv')
