...
history_results.to_csv('results/ICA_LSTM_60secs_MSE_loss.csv')
model.save('models/ICA_LSTM_60secs_MSE.h5')
...
prediction_results.to_csv('results/ICA_LSTM_60secs_MSE_prediction.csv')
